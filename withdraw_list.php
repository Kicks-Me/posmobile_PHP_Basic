<div class="row" style="padding-top: 10px;">
    <div style="margin-top:1rem; width: 100%; padding: 15px;">
        <center style="padding-bottom: .5rem;">
            <h5 style="border-bottom:1px solid #999; padding-bottom: 10px;">Withdraw List</h5>
        </center>
        <table width="100%">  
        ...
        <?php 
            ...
            $qry = $conn->query("SELECT*FROM docs WHERE doc_status = 1 AND doc_type = 'OUT' ORDER BY doc_suplier ASC, doc_id DESC limit 50");
        ...
        ?>
            <tr style="border-bottom: 1px dotted #ccc;">
                ...
                <td align="left" onclick="ajax('withdraw_form&docid=<?php echo $rs->doc_id; ?>','showDetail')" style="cursor: pointer;">
                    <div>
                ...
                <td align="right">
                    <div class=" btn-group">
                        <button class="btn btn-danger" style="padding:0px;" onclick="if(confirm('Do you want to delete this item ?')) ajax('withdraw_list&del=<?php echo $rs->doc_id; ?>','showDetail');"><i class="fas fa-minus-circle"style="margin: .4rem; cursor: pointer; color: #fff;"></i></button>
                    </div>
                </td>
            </tr>
        <?php } ?>
